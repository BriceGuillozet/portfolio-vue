<template>
    <div id="app">
        <div id="nav">
            <router-link to="/" class="nav__items">Home</router-link>
            <router-link to="/projects" class="nav__items">Projets</router-link>
            <router-link to="/about" class="nav__items"
...
#app {
    ...
    width: 100vw;
    height: 100vh;
    background: linear-gradient(#2e3445, #222733);
    color: white;
    display: flex;
